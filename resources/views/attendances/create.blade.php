@extends('master')
@section('title', 'Form Input Absensi')
@section('content')
<div class="container mt-10 centered mx-auto px-4">
    
    <p class="text-center text-4xl font-bold text-gray-900 dark:text-white my-10">Form Input Absensi</p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-2 pb-4 w-2/3">
                            {{-- PERBAIKAN: name="karyawan_id" --}}
                            <select id="karyawan_id" name="karyawan_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('karyawan_id') border-red-500 @enderror">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-2 pb-4 w-2/3">
                            ...
                            <input 
                                ...
                                step="1" {{-- Penting untuk format H:i:s atau H:i --}}
                                required 
                            >
                            @error('waktu_masuk')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
